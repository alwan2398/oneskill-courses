...
import { aboutValues, iconComponents } from "@/constant";
import { Rocket, Target } from "lucide-react";

export default function About() {
  const aboutData = {
    title: "Platform pembuatan kursus bertenaga AI untuk.",
    subtitle:
      "pembuat kursus tradisional untuk menyiapkan materi pembelajaran mikro yang ringkas, interaktif, dan menarik.",
    mission:
      "membangun kursus daring berdasarkan sumber daya Anda hingga menghasilkan interaksi, Pembuat Kursus AI kami menyediakan perangkat lengkap untuk membuat kursus hebat dengan lebih cepat dengan AI.",
    vision:
      "pelatihan berbasis AI, keterlibatan manusia, pembelajaran di tempat kerja, penjualan kursus daring, atau perolehan prospek, platform tunggal ini mencakup semuanya.",
    values: aboutValues,
        ...
        <div ref={valuesRef} className="mb-24">
          ...
          >
            ...
            <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-lg">
              pengalaman belajar yang menarik bagi pembelajaran Anda
            </p>
          </motion.div>
